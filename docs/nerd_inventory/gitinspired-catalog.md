...
|  | source=https://github.com/github/awesome-copilot; notes=Local evidence found; review before installing anything new.; evidence=/root/.agents/plugins/skills/copilot-sdk, /root/.claude/skills/skills/copilot-sdk |  |  |  |  |  |
| `gitinspired-awesome-design-systems` | awesome-design-systems | candidate | missing | design | unknown | install_later |
|  | source=https://github.com/alexpate/awesome-design-systems; notes=No strong local evidence found in configured search roots. |  |  |  |  |  |
...
|  | source=https://github.com/unclecode/crawl4ai; notes=Local evidence found; review before installing anything new.; evidence=/root/.agents/plugins/skills/firecrawl-scraper, /root/.claude/skills/skills/firecrawl-scraper |  |  |  |  |  |
| `gitinspired-dify` | dify | candidate | missing | agents | unknown | install_later |
|  | source=https://github.com/langgenius/dify; notes=No strong local evidence found in configured search roots. |  |  |  |  |  |
| `gitinspired-ecc` | ECC | candidate | present | claude | unknown | normalize |
|  | source=https://github.com/affaan-m/ECC; notes=Local evidence found; review before installing anything new.; evidence=/root/.agents/plugins/skills/everything-claude-code |  |  |  |  |  |
...
| `gitinspired-graphify` | graphify | candidate | missing | knowledge | unknown | install_later |
|  | source=https://github.com/safishamsi/graphify; notes=No strong local evidence found in configured search roots. |  |  |  |  |  |
| `gitinspired-hackingtool` | hackingtool | candidate | missing | security | unknown | install_later |
|  | source=https://github.com/Z4nzu/hackingtool; notes=No strong local evidence found in configured search roots. |  |  |  |  |  |
| `gitinspired-mattpocock-skills` | mattpocock-skills | candidate | missing | skills | unknown | install_later |
|  | source=https://github.com/mattpocock/skills; notes=No strong local evidence found in configured search roots. |  |  |  |  |  |
| `gitinspired-mirofish` | MiroFish | candidate | missing | agents | unknown | install_later |
...
|  | source=https://github.com/nexu-io/open-design; notes=No strong local evidence found in configured search roots. |  |  |  |  |  |
| `gitinspired-openjarvis` | OpenJarvis | candidate | missing | agents | unknown | install_later |
|  | source=https://github.com/open-jarvis/OpenJarvis; notes=No strong local evidence found in configured search roots. |  |  |  |  |  |
| `gitinspired-openmythos` | OpenMythos | candidate | missing | agents | unknown | install_later |
...
|  | source=https://github.com/lyc-aon/successor-agent; notes=No strong local evidence found in configured search roots. |  |  |  |  |  |
| `gitinspired-tradingagents` | TradingAgents | candidate | present | finance | unknown | normalize |
|  | source=https://github.com/TauricResearch/TradingAgents; notes=Local evidence found; review before installing anything new.; evidence=/root/free-claude-code/TradingAgents, /root/free-claude-code/TradingAgents/tradingagents, /root/free-claude-code/TradingAgents/tradingagents.egg-info |  |  |  |  |  |
