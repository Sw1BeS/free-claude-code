...
This project is indexed by GitNexus as **free-claude-code** (9717 symbols, 19644 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
